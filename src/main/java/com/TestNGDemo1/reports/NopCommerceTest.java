package com.TestNGDemo1.reports;
...
public class NopCommerceTest {
	...
	// htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/MainFolderReports/myReport.html");
		 String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());//time stamp
			String repName="Test-Report-"+timeStamp+".html";
			
			htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+ "/MainFolderReports/"+repName);//
	 ...
	 @BeforeMethod
	 public void setup() {
	  System.setProperty("webdriver.chrome.driver", "C:\\Users\\venkatakrishnay\\eclipse-workspace\\TestNGDemoProject1\\Drivers\\chromedriver.exe");
	 ...
	 public void noCommerceTitleTest() {
	  ...
	  test.createNode("Title verified");
	  test.createNode("Title verified");
	  test.createNode("Title verified");
	  test.createNode("Title verified");
	  test.createNode("Title verified");
